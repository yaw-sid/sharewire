module github.com/yaw-sid/sharewire
...
// replace github.com/wailsapp/wails/v2 v2.0.0-beta.36 => /home/sid/go/pkg/mod/github.com/wailsapp/wails/v2@v2.0.0-beta.36
